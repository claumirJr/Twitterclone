        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                qtde_seguidores();
                 ...
                 function deletar_tweet(id_tweet){;
                    $.ajax({
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form id="form_tweet" class="input-group">
                            <input type="text" name="text_tweet" class="form-control" id="text_tweet" placeholder="O que está acontecendo agora?" maxlength="140">
